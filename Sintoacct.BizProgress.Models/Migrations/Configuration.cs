namespace Sintoacct.Progress.Models.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Sintoacct.Progress.Models.BizProgressContext>
    {
        ...
        protected override void Seed(Sintoacct.Progress.Models.BizProgressContext context)
        {
            ...
            context.BizItems.AddOrUpdate(items);

            int j = 1;
            foreach (BizItems i in items)
            {
                if(i.CateId==1)
                context.BizSteps.AddOrUpdate(
                    new BizSteps { StepName = "签订合同（口头协议）", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "任务分派", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "资料收取", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "核名", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "工商移出异常", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "工商档案迁移", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "提交设立", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "领取营业执照", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "印章刻制", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "领取印章", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "工商查档", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "税局信息采集", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "国税异常处理", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "地税异常处理", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "国税备案", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "地税备案", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "银行对公户信息变更", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "三方协议扣款重签", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "发票验旧及税盘重发行", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "代垫费用", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "费用对账", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "费用收取", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "资料归档", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "资料归还", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "客户回访", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "工商年报", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "沟通记录", SortIndex = 1, ItemId = j });
                ...
                context.BizSteps.AddOrUpdate(
                    ...
                    new BizSteps { StepName = "任务分派", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "资料收取", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "会计凭证提取", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "原始凭证整理", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "会计凭证录入", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "账务处理", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "报表编制", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "凭证打印及装订", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "账簿打印及装订", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "报表打印及装订", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "国税申报", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "缴纳国税税款", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "地税申报", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "缴纳地税税款", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "企业所得税汇算清缴", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "国税纳税申报表打印及装订", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "地税纳税申报表打印及装订", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "账套备份", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "报表、纳税申报表电子档存档", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "代垫费用", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "税控盘领购及发行", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "发票申请", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "发票增量申请提交", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "发票增量申请审批进度查询", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "发票增量审批结果", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "发票升位申请提交", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "发票升位申请审批进度查询", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "发票升位审批结果", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "对公户开立（撤销）资料提交", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "对公户开立（撤销）人行审批", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "对公户开户许可证领取（撤销）", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "对公户网银开通", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "国税打印三方协议扣款", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "地市打印三方协议扣款", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "银行签订三方协议扣款", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "三方协议扣款交回国税", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "三方协议扣款交回地税", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "残疾人就业保障金核定及缴纳", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "发票开具", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "税控盘现场清卡或解锁", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "一般纳税人认定资料提交", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "费用对账", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "费用收取", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "沟通记录", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "客服回访", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "资料归还", SortIndex = 1, ItemId = j });
                ...
                context.BizSteps.AddOrUpdate(
                    ...
                    new BizSteps { StepName = "任务分派", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "资料收取", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "申请材料准备", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "申请材料提交", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "申请材料审批进度查询", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "申请涉及费用缴纳", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "整改要求", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "整改材料提交", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "领取证件", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "费用对账", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "沟通记录", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "费用收取", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "资料归还", SortIndex = 1, ItemId = j },
                ...
                context.BizSteps.AddOrUpdate(
                    ...
                    new BizSteps { StepName = "资料收取", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "沟通记录", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "结果提交", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "结果反馈及修订", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "最终版报告提交", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "费用对账", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "费用收取", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "资料归还", SortIndex = 1, ItemId = j },
                    new BizSteps { StepName = "客户回访", SortIndex = 1, ItemId = j });

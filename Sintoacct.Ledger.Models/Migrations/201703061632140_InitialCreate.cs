                ...
                c => new
                    {
                        ...
                        YtdDebitQuantity = c.Decimal(precision: 18, scale: 2),
                        YtdDebit = c.Decimal(precision: 18, scale: 2),
                        YtdCreditQuantity = c.Decimal(precision: 18, scale: 2),
                        YtdCredit = c.Decimal(precision: 18, scale: 2),

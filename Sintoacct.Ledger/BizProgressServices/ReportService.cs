...
namespace Sintoacct.Ledger.BizProgressServices
{
    public class ReportService : IReportService
    {
        ...
        public List<ProgressListViewModel> GetProgressList(ProgressSearchViewModel condition)
        {
            ...
            string sql = "select top 500 o.[ContractTime],o.[BizManager],o.[BizOperations],o.[Recommend],o.[CommercialExpense],c.[CustomerName],i.ItemName,s.StepName,p.CompletedTime,p.ResultDesc,p.CreateTime,p.Creator" +
